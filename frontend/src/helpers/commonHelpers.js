...
export const noContentHtml = (date, format) => {
  return `
    <div id="notfound">
...
export function abbrev_name(str1) {
...
export function mediaType(filename) {
  ...
  let video = ".mp4, .mov, .mkv, .avi, .wmv, .flv, .webm";
  if (image.includes(filename.substr(filename.lastIndexOf(".")))) {
    return "image";
  } else if (
    video.includes(filename.toLowerCase().substr(filename.lastIndexOf(".")))
  ) {
    return "video";
  }
  return undefined;
